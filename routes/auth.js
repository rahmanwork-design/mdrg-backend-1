...
router.post('/register', async (req, res) => {
  try {
    ...
    // Insert new client
    await dbRun(
      `INSERT INTO clients (client_id, email, password, first_name, last_name, company_name, phone, address, city, postcode, original_creditor, account_reference, total_debt)
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
      [clientId, email, hashedPassword, first_name, last_name, company_name, phone, address, city, postcode, original_creditor || null, account_reference || null, total_debt || 0]
    );
