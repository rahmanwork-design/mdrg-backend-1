...
router.post('/register', async (req, res) => {
  try {
    ...
    // Insert new client
    await dbRun(
      `INSERT INTO clients (client_id, email, password, first_name, last_name, company_name, phone, address, city, postcode, total_debt, balance_due, original_creditor, account_reference)
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
      [clientId, email, hashedPassword, first_name, last_name, company_name, phone, address, city, postcode, debtAmount, debtAmount, original_creditor || '', account_reference || '']
    );
